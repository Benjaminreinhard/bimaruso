...
Enter your Bimaru into the `input.md` file according to the rules that are explained in the next section and then run `./bimaruso`.

## Input file

The `input.md` file has to look as follows:
...
In the entire file you can add as many whitespaces and newlines as you want. They are ignored by the program.
